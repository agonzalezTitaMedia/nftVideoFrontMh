...
const contractAddress = "0xE14C2d4DFac333Cc377512ebaBEee814DCa7613A";
...
const WrapNft = () => {
  ...
  const listOwners = async () => {
    ...
    const contractCall = new ethers.Contract(contractAddress, abi, signer);
    const cantidadNft = await contractCall.token_count();
    const countDecimal = cantidadNft.toString();
    ...
    return(
        ...
        {state ? 
          ...
          <button onClick={listOwners}> lista de dueños</button>
          </div> : 
